...
<div class="container well">
    ...
    <div class="row" style="margin-bottom: 50px;">
        ...
        <div class="col-md-1 col-md-offset-4" style="margin-left: 450px;">
            <h2><div class="header label label-primary">{{ $movie->name }}</div></h2>
        </div>
        ...
        <div class="col-md-10">
            ...
            <div class="col-md-offset-2">
                ...
                <div class="form-group">
                    ...
                    <div class="list-inline"> <li><div class="label label-default">Director:&nbsp;&nbsp;&nbsp;</div> </li> <li><div class="text-danger"><b>{{ $movie->director}}</b></div></li></div>

                </div>
                <div class="form-group">
                    <div class="list-inline"> <li><div class="label label-default">Release:&nbsp;&nbsp;&nbsp;</div> </li> <li><div class="text-danger"><b>{{ $movie->release}}</b></div></li></div>
                </div>
                <div class="form-group">
                    <div class="list-inline"> <li><div class="label label-default">Actors:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div> </li> <li><div class="text-danger"><b>{{ $movie->actors}}</b></div></li></div>
                </div>

                {{--<div class="form-group">   <div class="label label-default">Actors: </div> <div class="label label-info">{{ $movie->lang}}</div></div>--}}
                <div class="form-group">
                    <div class="list-inline"> <li><div class="label label-default">Language:</div> </li> <li><div class="text-danger"><b>{{ $movie->lang}}</b></div></li></div>
                </div>
                <div class="form-group">
                    <div class="list-inline"> <li><div class="label label-default">Studio:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div> </li> <li><div class="text-danger"><b>{{ $movie->studio}}</b></div></li></div>
                </div>
                <div class="form-group">
                    <div class="list-inline"> <li><div class="label label-default">Time:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div> </li> <li><div class="text-danger"><b>{{ $movie->time}}</b></div></li></div>
                </div>
    ...
    <div class="row">
        <div class="col-md-offset-1" style="margin-right: 100px; margin-left: 83px;">
            <div class="panel"><div class="panel-heading"> <div class="label label-default"> Description:</div></div> <div class="panel-body"> <div>{{ $movie->description}}</div></div></div>
        </div>
    </div>
    <div class="row">
